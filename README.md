...
## Overview
This experiment uses Terraform to create a single virtual machine on [Equinix' Managed Private Cloud - Flex Platform](https://https://docs.equinix.com/managed-solutions/globally-available/gms-new-managed-private-cloud/).  It is part of a series of experiments begun in early 2026.  I have structured the Terraform files with sequence numbers to show the logical flow of resource creation.  Roughly the sequence is:
...
* Step 8 - [Digital Ocean](https://github.com/andrew-siwko/terraform-equinix-test) (you are here)
...
## Observations
* Equinx is my eighth provisioning project.  
* Project stats:
  * Start: TBD
  * Functional: TPD
